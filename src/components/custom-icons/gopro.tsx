const GoProIcon = ({
  ...
  >
    ...
    <path
      fill="#fff"
      d="M766.9 209.77q.38.12.74.55.36.42.73 1.16l1.2 2.4h-1.27l-1.13-2.25q-.43-.88-.84-1.17-.4-.3-1.1-.3h-1.3v3.72h-1.2v-8.78h2.7q1.5 0 2.23.63.74.63.74 1.9 0 .83-.38 1.38-.4.6-1.12.8zm-2.98-3.7v3.13h1.5q.85 0 1.3-.4.43-.4.43-1.17 0-.77-.44-1.16-.4-.4-1.2-.4H764z"
